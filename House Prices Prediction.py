...
for ind in num_na_high:
    ...
    temp_order = cor_mat.abs().sort_index(by = ind,axis=0, ascending=False).sort_index(by = ind,axis=1, ascending=False)
...
rf = RandomForestClassifier(n_estimators=500, random_state = 2000)
