...
rm(train_df, test_df, imp.var.names, lasso.pred, lasso.pred2, lasso.submit)
...
rm(rf.grid, rf.perf.mat, g, f, final.perf.mat, opt.mtry, e.vec, rf.pred, rf.pred2, rf.submit)
