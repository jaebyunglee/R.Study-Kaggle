...
train = read.csv("C:/Users/jaebyung.lee/Desktop/kaggle/houseprice/train.csv",stringsAsFactors = FALSE)
test = read.csv("C:/Users/jaebyung.lee/Desktop/kaggle/houseprice/test.csv",stringsAsFactors = FALSE)
test$SalePrice = NA
...
final.submit = 2/3*lasso.pred+1/3*xgb.pred
final.submit = cbind(1461:2919,final.submit)
colnames(final.submit) = c("Id","SalePrice")
write.csv(final.submit,"C:/Users/jaebyung.lee/Desktop/kaggle/houseprice/xgb.lasso.weight.csv",row.names = FALSE)
